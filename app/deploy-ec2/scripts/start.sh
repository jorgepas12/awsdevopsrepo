...
sudo docker ps -q --filter "ancestor=316121670951.dkr.ecr.us-east-1.amazonaws.com/static-web:v1" | xargs -r sudo docker stop
...
sudo docker run -d -p 80:80 --rm --name static-web \
  ...
  316121670951.dkr.ecr.us-east-1.amazonaws.com/static-web:v1
